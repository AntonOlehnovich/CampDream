...
var imf = function () { 
    ...
    /* ===== Пользовательский getElementsByClass ==== */ 
    ...
    /* ===== Кроссбраузерная функция addEvent ==== */ 
    ...
    function ImageFlow(oCont, xmlfile, horizon, size, zoom, border, start, interval) { 
        ...
        /* ==== Добавляем обработку событий от колесика мыши ==== */ 
        ...
        /* ==== Перетаскивание полоски прокрутки  ==== */ 
    ...
    Diapo.prototype = { 
        ...
        move : function (res) { 
            ...
            if (this.loaded) { 
                ...
                if (Math.abs(sx) > 2 || Math.abs(sw) > 2 || res) { 
                    /* ---- Вывод только при перемещении ---- */ 
                    this.x0 += sx * .1; 
                    this.w0 += sw * .1; 
                    var h = this.w0 * this.r; 
                    this.z2 = (that.ht * that.horizon + 1 - this.z2 - h) *.5; 
                    if (this.x0 < that.wh && this.x0 + this.w0 > 0) { 
                        /* ---- Вывод только видимых изображений ---- */ 
                        this.visible = true; 
                        ...
                        /* ---- Отключаем невидимые изображения ---- */ 
                        if (this.visible) { 
                            this.visible = false; 
        ...
        click : function () { 
            ...
            if (this.parent.view == this.N) { 
                /* ---- Нажато на масштабирование diapo ---- */ 
                if (this.url) { 
                    /* ---- Открываем ссылку ---- */ 
    ...
    return { 
        ...
        reinit : function () { 
            ...
            delete instances;
            instances = [];
            document.getElementById('imageFlow').innerHTML = '<div class="text"><div class="title">Loading</div><div class="legend">Please wait...</div></div> <div class="scrollbar"> <img class="track" src="images/sb.gif" alt=""> <img class="arrow-left" src="images/sl.gif" alt=""> <img class="arrow-right" src="images/sr.gif" alt=""> <img class="bar" src="images/sc.gif" alt=""> </div>';
